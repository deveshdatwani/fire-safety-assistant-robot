...
<h3> This repository is to showcase my capstone experience for Fall 2022 at Worcester Polytechnic Institute under Prof Loris Fichera. </h3>
...
Engaging with them was extremely enlightening. I learned a great deal about firefighting scenarios and the challenges that pertain to them. 

Identifying the problem statement was the most challenging part as the stakeholders couldn't guide my team and I with finding problems that can be solved by a robot. In the Fire Department Chief's own words, "thinking out of the box" was not something they could do. Hence the onus of identifying challenges that can be solved by robots, was entirely on me and the team. 

Below are snapshots from our engagement with the Fire Chief and pictures of the Professors we reached out to for problem statement identification.
...
We proposed an additional **FIRE SAFETY STACK** for the roomba to map the indoor environment and calculate safety scores for any indoor environment. 
...
This was done through a Change Detection algorithm that was originally intended for remote sensing. I implemented it on cloud point data to detect obstacles and localize them in the map frame.
...
The CD algorithm detects changes in an image and outputs a binary image with the changes only. This is done with PCA and K Means clustering on difference image obtained from ground truth map and real time map.
...
The sum of the convolutions was mapped to fire safety of a home. 
...
We found out that increase in path lengths meant the presence of an obstacle while also indicating that it takes a longer path to safety. This could prove hazardous in a fire emergency situation.
...
<p align="center"><img src="https://raw.githubusercontent.com/deveshdatwani/fire-safety-assistant-robot/main/assets/scan.png" width=200><img src="https://raw.githubusercontent.com/deveshdatwani/fire-safety-assistant-robot/main/assets/scan1.png" width=200><img src="https://raw.githubusercontent.com/deveshdatwani/fire-safety-assistant-robot/main/assets/scan2.png" width=200></p>
